angular.module('Onlinemandi.directives', [])
    ...
    .directive('testproduct', function($filter, $ionicPopup, $ionicModal, $state, $rootScope, UserFactory, AuthFactory, CartFactory, ProductsFactory, WeightFactory, Loader) {
        return {
            restrict: 'E',
            scope: {
                product:'=productAttr',
            ...
            templateUrl: 'templates/testproduct.html',
            link: function(scope, elem, attrs) {
                if($rootScope.isAuthenticated){
                    ...
                    //scope.weights = WeightFactory.getWeights(scope.product);
